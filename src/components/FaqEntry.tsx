  ...
  return (
    <li className="py-6">
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className="group flex w-full items-baseline justify-between gap-6 text-left focus-ring"
      >
        ...
        <span
          aria-hidden
          className="ml-auto inline-grid h-6 w-6 shrink-0 place-items-center rounded-pill border border-border-strong font-mono text-[13px] text-muted-strong transition-transform"
        ...
        {open ? (
          ...
          >
            <div className="ml-12 mt-4 border-l border-rule pl-5">
              <p className="font-sans text-[17.5px] leading-relaxed text-foreground-soft">
                {answer}
              </p>
            </div>
          </motion.div>
